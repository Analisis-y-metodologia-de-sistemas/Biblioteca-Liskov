...
class TestAuthService(unittest.TestCase):
    ...
    def test_cambiar_password_exitoso(self):
        ...
        empleado = Empleado(
            ...
            nombre="Test",
            usuario_sistema="test",
            password_hash=self.auth_service.hash_password(password_actual)
        )
    ...
    def test_cambiar_password_actual_incorrecta(self):
        ...
        empleado = Empleado(
            id=1,
            nombre="Test",
            password_hash=self.auth_service.hash_password("correct_old")
        )
    ...
    def test_listar_empleados_activos(self):
        ...
        # Arrange
        empleados_esperados = [
            Empleado(id=1, nombre="Ana", activo=True),
            Empleado(id=2, nombre="Carlos", activo=True)
        ]
