...
from src.domain.entities import Usuario, ItemBiblioteca, Prestamo, Multa, TipoUsuario, CategoriaItem, EstadoItem
from src.application.services import PrestamoService
from src.application.interfaces import IPrestamoRepository, IItemBibliotecaRepository, IUsuarioRepository, IMultaRepository
...
class TestPrestamoService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.prestamo_service = PrestamoService(
            self.mock_prestamo_repo,
            self.mock_item_repo,
            self.mock_usuario_repo,
            self.mock_multa_repo
        )
    ...
    def test_realizar_prestamo_item_inexistente(self):
        ...
        # Arrange
        usuario = Usuario(id=1, nombre="Juan", apellido="Pérez", email="juan@test.com",
