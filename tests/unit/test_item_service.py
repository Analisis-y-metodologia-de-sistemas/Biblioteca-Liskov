...
from src.domain.entities import ItemBiblioteca, CategoriaItem, EstadoItem
...
class TestItemBibliotecaService(unittest.TestCase):
    ...
    def test_agregar_item_categoria_invalida(self):
        ...
        with self.assertRaises(ValueError):
            self.item_service.agregar_item(
                titulo="Test Book",
    ...
    def test_listar_por_categoria(self):
        ...
        items_esperados = [
            ItemBiblioteca(
                ...
                categoria=CategoriaItem.REVISTA,
                estado=EstadoItem.DISPONIBLE
            )
        ]
    ...
    def test_cambiar_estado_item_exitoso(self):
        ...
        item_actualizado = ItemBiblioteca(
            id=1,
            titulo="Test Book", 
            categoria=CategoriaItem.LIBRO,
            estado=EstadoItem.PRESTADO
