...
from src.domain.entities import CategoriaItem, TipoUsuario
    ...
    try:
        ...
        items = [
            ...
            (
                ...
                "978-0132350884",
                CategoriaItem.LIBRO_ALUMNO,
                "Principios de programación limpia",
                "Estante A-3",
            ),
