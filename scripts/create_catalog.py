        ...
        catalogo = {
            "libro": [
                ...
                },
                {
                    ...
                    "isbn": "978-0596517748",
                    "descripcion": "Las mejores características de JavaScript",
                    "ubicacion": "Tech-A2",
                },
                {
                    ...
                    "isbn": "978-0134494166",
                    "descripcion": "Guía para crear software mantenible",
                    "ubicacion": "Tech-A3",
                },
                {
                    ...
                    "autor": "Gang of Four",
                    "isbn": "978-0201633612",
                    "descripcion": "Patrones de diseño reutilizables",
                    "ubicacion": "Tech-A4",
                },
                {
                    ...
                    "autor": "Andrew Hunt",
                    "isbn": "978-0135957059",
                    "descripcion": "De aprendiz a maestro",
                    "ubicacion": "Tech-A5",
                },
                {
                    "titulo": "Cracking the Coding Interview",
                    "autor": "Gayle McDowell",
                    "isbn": "978-0984782857",
                    "descripcion": "189 preguntas de programación",
                    "ubicacion": "Tech-A6",
                },
                {
                    "titulo": "System Design Interview",
                    "autor": "Alex Xu",
                    "isbn": "978-1736049112",
                ...
                },
                {
                    ...
                    "autor": "Joshua Bloch",
                    "isbn": "978-0134685991",
                    "descripcion": "Mejores prácticas en Java",
                    "ubicacion": "Tech-A8",
                },
                # Ciencias y Matemáticas
                {
                    ...
                    "autor": "James Stewart",
                    "isbn": "978-1285740621",
                    "descripcion": "Fundamentos del cálculo",
                    "ubicacion": "Math-B1",
                },
                {
                    ...
                    "isbn": "978-0980232776",
                    "descripcion": "Introducción al álgebra lineal",
                    "ubicacion": "Math-B2",
                },
                {
                    ...
                    "autor": "Sheldon Ross",
                    "isbn": "978-0123948113",
                    "descripcion": "Fundamentos estadísticos",
                    "ubicacion": "Math-B3",
                },
                {
                    ...
                    "autor": "Hugh Young",
                    "isbn": "978-0321973610",
                    "descripcion": "Física con aplicaciones modernas",
                    "ubicacion": "Sci-B4",
                },
                {
                    ...
                    "autor": "Raymond Chang",
                    "isbn": "978-0073402680",
                    "descripcion": "Principios de química",
                    "ubicacion": "Sci-B5",
                },
                {
                    ...
                    "autor": "Bruce Alberts",
                    "isbn": "978-0815344322",
                    "descripcion": "La célula como unidad básica",
                    "ubicacion": "Sci-B6",
                },
                # Literatura y Humanidades
                {
                    ...
                    "isbn": "978-0307389732",
                    "descripcion": "Realismo mágico latinoamericano",
                    "ubicacion": "Lit-C1",
                },
                {
                ...
                },
                {
                    ...
                    "autor": "George Orwell",
                    "isbn": "978-0451524935",
                    "descripcion": "Distopía totalitaria",
                    "ubicacion": "Lit-C3",
                },
                {
                    ...
                    "isbn": "978-0743273565",
                    "descripcion": "La era del jazz americano",
                    "ubicacion": "Lit-C4",
                },
                {
                    ...
                    "autor": "Jane Austen",
                    "isbn": "978-0141439518",
                    "descripcion": "Romance victoriano",
                    "ubicacion": "Lit-C5",
                },
                {
                    "titulo": "Rayuela",
                    ...
                    "isbn": "978-8437604572",
                    "descripcion": "Novela experimental argentina",
                    "ubicacion": "Lit-C6",
                },
                {
                    ...
                    "autor": "Franz Kafka",
                    "isbn": "978-0486290300",
                    "descripcion": "Alegoría existencial",
                    "ubicacion": "Lit-C7",
                },
                ...
                },
                {
                    ...
                    "autor": "Sun Tzu",
                    "isbn": "978-1590302255",
                    "descripcion": "Estrategia militar antigua",
                    "ubicacion": "Hist-D2",
                },
                {
                ...
                },
                {
                    ...
                    "isbn": "978-8478442355",
                    "descripcion": "Historia de la filosofía",
                    "ubicacion": "Phil-D4",
                },
                {
                    ...
                    "autor": "Lou Marinoff",
                    "isbn": "978-8466318846",
                    "descripcion": "Filosofía para la vida cotidiana",
                    "ubicacion": "Phil-D5",
                },
                # Economía y Negocios
                {
                ...
                },
                {
                    ...
                    "isbn": "978-0060555665",
                    "descripcion": "Principios de inversión",
                    "ubicacion": "Biz-E2",
                },
                {
                    "titulo": "Freakonomics",
                    "autor": "Steven Levitt",
                    "isbn": "978-0060731335",
                    "descripcion": "Economía de lo inesperado",
                    "ubicacion": "Biz-E3",
                },
                {
                    ...
                    "autor": "Jim Collins",
                    "isbn": "978-0066620992",
                    "descripcion": "Por qué algunas empresas destacan",
                    "ubicacion": "Biz-E4",
                },
                {
                    ...
                    "autor": "Eric Ries",
                    "isbn": "978-0307887894",
                    "descripcion": "Innovación empresarial",
                    "ubicacion": "Biz-E5",
                },
            ],
            "revista": [
                {
                    "titulo": "National Geographic Español",
                    "autor": "Varios",
                    "isbn": "ISSN-1138-1434",
                    "descripcion": "Revista de geografía y naturaleza",
                    "ubicacion": "Rev-F1",
                },
                {
                ...
                },
                {
                    ...
                    "autor": "Varios",
                    "isbn": "ISSN-0018-9162",
                    "descripcion": "Revista de tecnología",
                    "ubicacion": "Rev-F3",
                },
                {
                    "titulo": "Harvard Business Review",
                    "autor": "Varios",
                    "isbn": "ISSN-0017-8012",
            ...
            "cd": [
                {
                    "titulo": "Curso de Python Completo",
                    "autor": "MIT OpenCourseWare",
                    "isbn": "CD-001",
                    "descripcion": "Curso completo de programación",
                    "ubicacion": "CD-G1",
                },
                {
                    ...
                    "autor": "Khan Academy",
                    "isbn": "CD-002",
                    "descripcion": "Ejercicios interactivos",
                    "ubicacion": "CD-G2",
                },
                {
                    ...
                    "autor": "BBC Learning",
                    "isbn": "CD-003",
                    "descripcion": "Documentales educativos",
                    "ubicacion": "CD-G3",
                },
            ],
            "dvd": [
                {
                    "titulo": "Cosmos: Una Odisea Espacial",
                    "autor": "Neil deGrasse Tyson",
                    "isbn": "DVD-001",
                    "descripcion": "Serie documental científica",
                    "ubicacion": "DVD-H1",
                },
                {
                    "titulo": "Planet Earth",
                    "autor": "BBC",
                    "isbn": "DVD-002",
                    "descripcion": "Documental sobre la naturaleza",
                    "ubicacion": "DVD-H2",
                },
                {
                    "titulo": "The Code",
                    "autor": "BBC",
                    "isbn": "DVD-003",
                    "descripcion": "Matemáticas en la naturaleza",
                    "ubicacion": "DVD-H3",
                },
            ],
        }
